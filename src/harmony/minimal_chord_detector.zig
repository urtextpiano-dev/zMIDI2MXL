...
pub const MinimalChordDetector = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) MinimalChordDetector { return .{ .allocator = allocator }; }
    ...
    fn compareByStartTick(_: void, a: TimedNote, b: TimedNote) bool { return a.start_tick < b.start_tick; }
    fn compareByPitch(_: void, a: TimedNote, b: TimedNote) bool { return a.note < b.note; }
